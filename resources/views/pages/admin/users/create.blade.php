        ...
        <div class="modal-content">
                ...
                <div class="row mb-6">
                    ...
                    <div class="col-lg-8 fv-row fv-plugins-icon-container">
                        <select name="country" aria-label="Select a Country" data-control="select2"
                                ...
                                data-select2-id="select2-data-9-d54a" tabindex="-1" aria-hidden="true"
                                data-kt-initialized="1">
                            <option value="" data-select2-id="select2-data-11-ef0r">Select a Country...</option>
                            ...
                            <option data-kt-flag="flags/bosnia-and-herzegovina.svg" value="BA">Bosnia and Herzegovina
                            </option>
                            ...
                            <option data-kt-flag="flags/st-vincent-and-the-grenadines.svg" value="VC">Saint Vincent and
                                the Grenadines
                            </option>
                            ...
                            <option data-kt-flag="flags/zimbabwe.svg" value="ZW">Zimbabwe</option>
                                       ...
                                       data-select2-id="select2-data-10-pdb9" style="width: 100%;"><span
                                class="selection"><span
                                    ...
                                    aria-disabled="false" aria-labelledby="select2-country-2n-container"
                                    aria-controls="select2-country-2n-container"><span
                                        class="select2-selection__rendered" id="select2-country-2n-container"
                ...
                <div class="row mb-6">
                    ...
                    <div class="col-lg-8 fv-row fv-plugins-icon-container">
                        ...
                        <select name="language" aria-label="Select a Language" data-control="select2"
                                ...
                                data-select2-id="select2-data-12-efom" tabindex="-1" aria-hidden="true"
                                data-kt-initialized="1">
                            <option value="" data-select2-id="select2-data-14-6pyf">Select a Language...</option>
                            ...
                            <option data-kt-flag="flags/united-kingdom.svg" value="en-gb">English UK - British English
                            </option>
                            ...
                            <option data-kt-flag="flags/taiwan.svg" value="zh-tw">繁體中文 - Traditional Chinese
                                       ...
                                       data-select2-id="select2-data-13-5acm" style="width: 100%;"><span
                                class="selection"><span
                                    class="select2-selection select2-selection--single form-select form-select-solid form-select-lg"
                                    role="combobox" aria-haspopup="true" aria-expanded="false" tabindex="0"
                                    aria-disabled="false" aria-labelledby="select2-language-h2-container"
                                    aria-controls="select2-language-h2-container"><span
                                        class="select2-selection__rendered" id="select2-language-h2-container"
                ...
                <div class="row mb-6">
                    ...
                    <div class="col-lg-8 fv-row fv-plugins-icon-container">
                        <select name="timezone" aria-label="Select a Timezone" data-control="select2"
                                ...
                                class="form-select form-select-solid form-select-lg select2-hidden-accessible"
                                data-select2-id="select2-data-15-7xnw" tabindex="-1" aria-hidden="true"
                                data-kt-initialized="1">
                            <option value="" data-select2-id="select2-data-17-ssiz">Select a Timezone..</option>
                            ...
                            <option data-bs-offset="46800" value="Nuku'alofa">(GMT+13:00) Nuku'alofa</option>
                                       ...
                                       data-select2-id="select2-data-16-mnk9" style="width: 100%;"><span
                                class="selection"><span
                                    class="select2-selection select2-selection--single form-select form-select-solid form-select-lg"
                                    role="combobox" aria-haspopup="true" aria-expanded="false" tabindex="0"
                                    aria-disabled="false" aria-labelledby="select2-timezone-jg-container"
                                    aria-controls="select2-timezone-jg-container"><span
                                        class="select2-selection__rendered" id="select2-timezone-jg-container"
                                        role="textbox" aria-readonly="true" title="Select a timezone.."><span
                                            class="select2-selection__placeholder">Select a timezone..</span></span><span
                                        class="select2-selection__arrow" role="presentation"><b role="presentation"></b></span></span></span><span
                                class="dropdown-wrapper" aria-hidden="true"></span></span>
                        <div
                            class="fv-plugins-message-container fv-plugins-message-container--enabled invalid-feedback"></div>
                ...
                <div class="row mb-6">
                    ...
                    <div class="col-lg-8 fv-row">
                        <select name="currnecy" aria-label="Select a Currency" data-control="select2"
                                ...
                                class="form-select form-select-solid form-select-lg select2-hidden-accessible"
                                data-select2-id="select2-data-18-xj3j" tabindex="-1" aria-hidden="true"
                                data-kt-initialized="1">
                            <option value="" data-select2-id="select2-data-20-rgo9">Select a currency..</option>
                            ...
                            <option data-kt-flag="flags/switzerland.svg" value="CHF">
                                CHF&nbsp;-&nbsp;Swiss franc
                                       ...
                                       data-select2-id="select2-data-19-wn5d" style="width: 100%;"><span
                                class="selection"><span
                                    class="select2-selection select2-selection--single form-select form-select-solid form-select-lg"
                                    role="combobox" aria-haspopup="true" aria-expanded="false" tabindex="0"
                                    aria-disabled="false" aria-labelledby="select2-currnecy-a5-container"
                                    aria-controls="select2-currnecy-a5-container"><span
                                        class="select2-selection__rendered" id="select2-currnecy-a5-container"
                                        role="textbox" aria-readonly="true" title="Select a currency.."><span
                                            class="select2-selection__placeholder">Select a currency..</span></span><span
                                        class="select2-selection__arrow" role="presentation"><b role="presentation"></b></span></span></span><span
                                class="dropdown-wrapper" aria-hidden="true"></span></span>
                    </div>
                    <!--end::Col-->
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-primary"
                        id="kt_modal_create_user_submit">{{ __('admin.users.actions.create') }}</button>
            </div>
            <!--end::Modal footer-->
        </div>
        <!--end::Modal content-->
